...
TARGET_LOCAL_CPPFLAGS += -mfpu=neon -mfloat-abi=softfp

TARGET_LOCAL_CFLAGS += -DREFRESH_RATE=60 -DBINDER_COMPAT
...
TARGET_LOCAL_CFLAGS += -DNEEDS_VECTORIMPL_SYMBOLS -DEGL_NEEDS_FNW -DJAVA_HWC

# libwvm.so
TARGET_LOCAL_CFLAGS += -DADD_LEGACY_ACQUIRE_BUFFER_SYMBOL
